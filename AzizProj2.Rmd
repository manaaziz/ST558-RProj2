...
# Summarization
To get an idea of what we are working with when considering this data, we want to get some summaries of the data. Firstly, I wanted to see how much of the data pertained to each day.
```{r plot1, echo=FALSE}
