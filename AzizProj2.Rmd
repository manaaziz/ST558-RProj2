...
All that being said, I used 17 of these 20 variables as my predictors in my models, since the `is_-day` variables are irrelevant if we are doing the reports by day. This is also consistent with what we learned in the lectures about how many predictors to use in a regression tree, which is $\frac{1}{3}(\text{# of predictors})$ = 20 in this case.  
